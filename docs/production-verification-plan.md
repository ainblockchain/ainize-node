...
| The gas-price policy: who pays (buyer pays gas on the transfer; seller pays gas on anchor/attest/settle/payout) and the price floor (proposal: `defaultPrice ≥ 3 × gas` of a purchase) | otherwise the product sells at a loss and royalty payouts are gas-negative |
