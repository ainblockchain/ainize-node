...
- Operations grouped under English tags 'Find knowledge', 'Live test', 'Automatic payment & download', 'Register & sell knowledge', 'Public record', 'Operator', 'P2P'; each row has a method badge (GET/POST/PATCH/DELETE), path, summary, and 'operator auth' on protected endpoints; expanding shows 'Parameters', 'Request body', 'Responses'
...
- Step 5 returns `{"error":"free live-test quota exhausted for this hour — buy the patch or run your own node"} 429`
